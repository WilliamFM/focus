<cfscript>
            ...
            http url='http://couchdb.focusjr.com:5984/cache/_design/cache/_view/total_items?group_level=1' method='post' result='local.getCount' {
            ...
            http url='http://couchdb.focusjr.com:5984/cache/' method='post' result='local.insertCache' {
