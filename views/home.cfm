									    ...
									    <div>
									        ...
									        <div class="inner-spacer chat-widget widget-content-padding"> 
									              ...
									              <div class="tab-pane fade in active" id="user1">
									              	...
									              	<div class="chat-messages">
														...
														<p id="message-id-1" class="message-box">
															<img src="/includes/jarvis/img/avatar/avatar_1.jpg" alt="">
															<span class="message">
									              ...
									              <div class="tab-pane fade" id="user2">
									              	...
									              	<div class="chat-messages">
														...
														<p id="message-id-4" class="message-box">
															<img src="/includes/jarvis/img/avatar/avatar_2.jpg" alt="">
															<span class="message">
									            ...
									            <div class="row-fluid chat-box">
													...
													<div class="row-fluid">
		                                                <div class="span6 type-effect" style="display:none"><img src="/includes/jarvis/img/loaders/misc/16-2.gif" alt=""> Victoria is typing...</div>
